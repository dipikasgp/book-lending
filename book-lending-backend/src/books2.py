...
BOOKS = [
    Book(1, 'Computer Science Pro', 'codingwithdipika', 'A very nice book!', 5, 2030),
    Book(2, 'Be Fast with FastAPI', 'codingwithdipika', 'A great book!', 5, 2030),
    Book(3, 'Master Endpoints', 'codingwithdipika', 'A awesome book!', 5, 2029),
